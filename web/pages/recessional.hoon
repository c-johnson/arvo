      ...
      ;div
        ;div.header
          ;div(class "row nav text-400")
            ;a(href "{(trip -:s.bem.gas)}", class "mr-2"): Home
            ; | 
            ...
            ;*  ?:  authed
              ;=
                ; | 
                ;a(href "poast", class "ml-2 mr-2"): Poast
              ==
            ;=
              ; | 
              ;a(href "../~~/pages/recessional", class "ml-2 mr-2"): Login
            ==
          ==
          ;div(class "row title")
            ;h1: Recessional
            ...
            ;div(class "entry row mb-20 {(trip type.b)}")
              ;div(class "col-sm-12 col-md-6")
                ;div(class "datestamp text-mono")
                  ;a(href "recessional/{(trip a)}.blurb"): {(trip a)}
                ==
              ==
              ;div(class "col-sm-12 col-md-6")
                +{body.b}
                    ...
                    ;*  ?:  (gth page 0)
                      ;=
                        ;button(class "btn-sm btn-tetiary")
                          ;a(href "{(trip -:s.bem.gas)}?page={(scow %ud (sub page 1))}")
                            ; Prev
                          ==
                        ==
                      ==
